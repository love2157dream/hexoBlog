...
- [Resources 资源](#resources)
    ...
    - [External Resources 外部资源](#external-resources)
    - [Job Portal 求职门户](#job-portal)
    - [Community 社区](#community)
    - [Conferences 会议](#conferences)
    - [Podcasts 博客](#podcasts)
    - [Official Examples 官方例子](#official-examples)
    - [Tutorials 教程](#tutorials)
    - [Examples 例子](#examples)
    - [Books 图书](#books)
- [Projects Using Vue.js 使用Vue.js的项目](#projects-using-vuejs)
  - [Open Source 开源](#open-source)
  - [Commercial Products 商业产品](#commercial-products)
  - [Apps/Websites 应用程序/网站](#appswebsites)
  - [Interactive Experiences 互动体验](#interactive-experiences)
  - [Enterprise Usage 企业用法](#enterprise-usage)
- [Components & Libraries 组件和库](#components--libraries)
  - [UI Components UI组件](#ui-components)
    - [Table 表](#table)
    ...
    - [Tooltip 提示](#tooltip)
    - [Overlay 覆盖](#overlay)
    - [Parallax 视觉差](#parallax)
    - [Icons 图标](#icons)
    - [Menu 菜单](#menu)
    - [Carousel 圆盘传送带](#carousel)
    - [Charts 图表](#charts)
    - [Time 时间](#time)
    - [Calendar 日历](#calendar)
    - [Map 地图](#map)
    - [Audio / Video 音频/视频](#audio--video)
    - [Infinite Scroll 无限滚动](#infinite-scroll)
    - [Pull-to-refresh 上拉下拉刷新](#pull-to-refresh)
    - [Markdown Markdown文本编辑器](#markdown)
    - [PDF PDF](#pdf)
    - [Tree 树](#tree)
    - [Social Sharing 社交分享](#social-sharing)
    - [QR Code 二维码](#qr-code)
    - [Search 搜索](#search)
    ...
    - [Form 表单](#form)
      ...
      - [Type Select 类型选择](#type-select)
      - [Color Picker 选色器](#color-picker)
      - [Switch 开关](#switch)
      - [Masked Input 蒙版输入](#masked-input)
      - [Rich Text Editing 富文本编辑](#rich-text-editing)
      - [Image Manipulation 图像操作](#image-manipulation)
      - [File Upload 文件上传](#file-upload)
      - [Context Menu 上下文菜单](#context-menu)
      - [Miscellaneous 杂项](#miscellaneous-1)
  - [UI Layout UI布局](#ui-layout)
  - [Frameworks 框架](#frameworks)
    - [Responsive 响应](#responsive)
    - [Mobile 移动](#mobile)
    - [Component Collections 组件集合](#component-collections)
    - [Admin Template 管理模板](#admin-template)
    - [Other 其他](#other)
  - [UI Utilities UI实用程序](#ui-utilities)
    - [Event Handling 事件处理](#event-handling)
    - [Responsive Design 响应式设计](#responsive-design)
    - [Form 表单](#form-1)
      - [Validation 验证](#validation)
    - [Scroll 滚动](#scroll)
    - [Routing 路由](#routing)
    - [Lazy Load 延迟加载](#lazy-load)
    - [Pagination 分页](#pagination)
    - [Animation 动画](#animation)
    - [Meta Tags 元标记](#meta-tags)
    - [Portal 门户](#portal)
    - [Filters 过滤器](#filters)
    - [SVG SVG](#svg)
    - [Miscellaneous 杂项](#miscellaneous-2)
    - [WebGL WebGL](#webgl)
  - [Utilities 公共事业](#utilities)
    - [Typescript 打字稿](#typescript)
    - [HTTP Requests HTTP请求](#http-requests)
    - [i18n 国际化](#i18n)
    - [Custom Events 自定义事件](#custom-events)
    - [Persistence 集成](#persistence)
    - [State Management 状态管理](#state-management)
      - [Redux](#redux)
      - [Mobx](#mobx)
      - [Vuex Utilities](#vuex-utilities)
    - [Concurrency Management 并发管理](#concurrency-management)
    - [Code Style 代码样式](#code-style)
    - [CSS](#css)
    - [Asset Management 资产管理](#asset-management)
    - [Page Navigation 页面导航](#page-navigation)
    - [Miscellaneous 杂项](#miscellaneous-3)
    - [Web Workers 网络工作者](#web-workers)
    - [JSX](#jsx)
    - [Migration 移民](#migration)
    - [Web Sockets Web套接字](#web-sockets)
    - [Payment 付款](#payment)
      - [Stripe 条纹](#stripe)
  ...
  - [Dev Tools 开发工具](#dev-tools)
    ...
    - [Docs 文档](#docs)
    - [Test 测试](#test)
    - [Source Code Editing 源代码编辑](#source-code-editing)
      - [Atom](#atom)
  ...
  - [Scaffold 脚手架](#scaffold)
    ...
    - [Parts](#parts)
  - [Runtime 运行](#runtime)
    - [Command Line / Terminal 命令行/终端](#command-line--terminal)
...
- [Official Guide 官方指南](http://vuejs.org/guide/)
- [API Reference API参考](http://vuejs.org/api/)
- [GitHub Repo GitHub资源](https://github.com/vuejs/vue)
- [Release Notes 发行说明](https://github.com/vuejs/vue/releases)

### External Resources 外部资源

- [Vue.js資料まとめ(for japanese)](https://gist.github.com/hashrock/f575928d0e109ace9ad0) by @hashrock
- [Vue.js Newsletter Vue.js通讯](http://vue-newsletter.com/) - Weekly dose of handpicked Vue.js news 每周精心挑选的Vue.js消息
- [Vue.js Tips Vue.js提示](http://vuetips.com) - Tips to become a better Vue.js developer 成为更好的Vue.js开发者的提示
- [Vue.js Wikipedia Vue.js维基百科](https://en.wikipedia.org/wiki/Vue.js)
- [Vue.js Radar Vue.js雷达](https://www.vuejsradar.com) - Curated newsletter + site covering new Vue.js releases/contributions. 策展新闻通讯+网站，涵盖新的Vue.js版本/贡献。
 


### Job Portal 求职门户

- [Vue.js Jobs - VueJobs](https://vuejobs.com/) - A Vue.js job portal to hire or get hired for all your Vue.js jobs. 一个Vue.js工作门户网站雇用或获得您所有的Vue.js工作。

### Community 社区

- [Twitter 推特](https://twitter.com/vuejs)
- [Official Forum 官方论坛](http://forum.vuejs.org/)
- [vue-requests](https://github.com/vuejs/vue-requests) - Request a Vue.js module you wish existed or get ideas for modules 请求您希望存在的Vue.js模块或获取模块的建议
- [VueJS Iran - Telegram Channel & group (group link available in channel bio)](https://telegram.me/vue_js) VueJS伊朗 - 电报频道＆组（群组链接可在频道生物）
- [vueslack - 1300+ registered users worldwide](https://vueslack.com/) vueslack - 全球1300多个注册用户
- [Vue Land - Discord chat server](https://vue-land.js.org/) Vue Land - 不和谐聊天服务器
- [VueJS Russia - Telegram Group [Russian]](https://t.me/vuejs_ru) VueJS俄罗斯 - 电报集团[俄罗斯]
- [VueJS Viet Nam - Facebook group](https://www.facebook.com/groups/vuejsvietnam/) VueJS越南 - 脸谱组
- [VueJS Spanish - Slack Group](https://slack.vue-es.org/) VueJS西班牙语 - Slack集团
- [VueJS Korean - Slack Group](https://vuejs-korea.signup.team/) VueJS韩国 - Slack集团
- [VueJS Thailand - Facebook Group](https://www.facebook.com/groups/VuejsThailand/) VueJS泰国 - Facebook集团
- [VueJS Brasil - Telegram Group [Portuguese]](https://t.me/vuejsbrasil) VueJS巴西 - 电报集团[葡萄牙文]
- [VueJS Brasil - Facebook Page [Portuguese]](https://www.facebook.com/vuejsbrasil/)
- [VueJS Brasil - Facebook Group [Portuguese]](https://www.facebook.com/groups/vuejsbr/)VueJS Brasil - 脸书组[葡萄牙文]
...
- [Full Stack Radio #30 (11-23-2015)](http://www.fullstackradio.com/30) 全栈收音机
- [JavaScript Jabber #187 (11-25-2015)](https://devchat.tv/js-jabber/187-jsj-vue-js-with-evan-you)
- [Changelog #184 (11-27-2015)](https://changelog.com/184/) 变更日志
- [Software Engineering Daily (12-29-2015)] 软件工程日报(http://softwareengineeringdaily.com/2015/12/29/front-end-javascript-with-evan-you/)
...
- [Request For Commits #12 - Crowdfunding Open Source (Vue.js) (06-15-2017)](https://changelog.com/rfc/12) 第12张图片 - 开源众筹
- [The Web Platform Podcast 132: Vue.js (07-27-2017)](http://thewebplatformpodcast.com/132-vuejs) 网络平台Podcast 132：Vue.js
...
- [Vue.js screencasts](https://laracasts.com/series/learn-vue-2-step-by-step) on Laracasts Laracasts上的Vue.js 截屏视频
- [What's New in Vue.js 1.0](http://www.sitepoint.com/whats-new-in-vue-js-1-0/) on Sitepoint Sitepoint上Vue.js 1.0的新功能
- [Build an App with Vue.js: From Authentication to Calling an API](https://auth0.com/blog/2015/11/13/build-an-app-with-vuejs/) on Auth0 blog 使用Vue.js构建应用程序：从身份验证到在Auth0博客上调用API
- [Create a GitHub File Explorer Using Vue.js](https://scotch.io/tutorials/create-a-github-file-explorer-using-vue-js) on Scotch.io 在Scotch.io上使用Vue.js创建一个GitHub文件浏览器
- [Vue.js Tutorial](http://vegibit.com/vue-js-tutorial/) on Vegibit Vue.js教程在Vegibit
- [Vue.js build set-up from scratch with webpack, vue-loader and hot reload](http://skyronic.com/2015/12/28/vue-project-scratch/) Vue.js使用webpack，vue-loader和hot reload从头构建
- [Vuex basics: Tutorial and explanation](http://skyronic.com/2016/01/03/vuex-basics-tutorial/) Vuex基础：教程和解释
- [Vuex introduction video - James Browne from London Vue.js Meetup #1](https://www.youtube.com/watch?v=l1KHL-TX3qs) Vuex介绍视频 - 来自伦敦Vue.js Meetup＃1的James Browne
- [Vue.js 中文系列视频教程](https://laravist.com/series/vue-js-1-0-in-action-series) on Laravist
- [Vue.js: The Basics](http://coligo.io/vuejs-the-basics/) on Coligo.io Vue.js：基础上Coligo.io
- [VueJs: Components](https://coligo.io/vuejs-components/) on Coligo.io VueJs： Coligo.io上的组件
- [Dynamic Components in Vue.js](https://coligo.io/dynamic-components-in-vuejs/) on Coligo.io Coligo.io上的Vue.js中的动态组件
- [Develop a Reactive Invoice App using Vue.js](http://craigmckenna.com/develop-a-reactive-invoice-app-using-vue-js/) on craigmckenna.com  在craigmckenna.com上使用Vue.js开发反应式发票应用程序
- [Understanding Filters in Vue.js](http://coligo.io/vuejs-filters/) on Coligo.io 了解Coligo.io上的Vue.js中的过滤器
- [Hybrid App Example with Laravel and Vue.js in Portuguese](https://www.youtube.com/watch?v=TGSJjDahlrQ) by @vedovelli 混合应用程序示例与Laravel和Vue.js葡萄牙语 @vedovelli
- [Creating a Markdown Editor with VueJs and GitHub's API](http://coligo.io/markdown-editor-vuejs/) on Coligo.io 创建降价编辑器与VueJs和GitHub的API上Coligo.io
